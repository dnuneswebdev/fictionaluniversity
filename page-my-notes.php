<?php
  ...
  ?>
    ...
    <div class="create-note">
      ...
      <textarea class="new-note-body" rows="5" placeholder="Your Note Here...."></textarea>
      <span class="submit-note">Create Note</span>
      <span class="note-limit-message">Note limit reached!(5)</span>
    </div>
      ...
      <ul id="my-notes" class="min-list link-list">
        ...
        while($userNotes->have_posts()) {
          ...
          <li data-id="<?php the_ID(); ?>"> <!-- ACHA O ID PRA USAR NO JAVASCRIPT CRUD-->
            ...
            <textarea readonly class="note-body-field" rows="5"><?php echo esc_textarea(get_the_content()) ?>
            </textarea>
